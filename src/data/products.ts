...
export const products: Product[] = [
  // TVs & Entertainment
  {
    ...
    brand: "Samsung",
    description:
      "Experience stunning 4K UHD picture quality with this Samsung Smart TV featuring Crystal Processor 4K and smart connectivity.",
    specifications: {
  ...
  },
  {
    ...
    brand: "LG",
    description:
      "Affordable Full HD Smart TV with webOS platform and built-in streaming apps.",
    specifications: {
  ...
  // Refrigerators
  {
    ...
    image: "/assets/doors.jpg",
    category: "refrigerators",
    brand: "Samsung",
    description:
      "Spacious double door refrigerator with digital inverter technology and frost-free cooling.",
    specifications: {
      Capacity: "350 Liters",
      Type: "Double Door",
  ...
  },
  {
    ...
    brand: "LG",
    description:
      "Compact single door refrigerator perfect for small families with efficient cooling.",
    specifications: {
      Capacity: "190 Liters",
      Type: "Single Door",
  ...
  // Washing Machines
  {
    ...
    price: 850000,
    originalPrice: 950000,
    image: "/assets/washes.jpg",
    category: "washing-machines",
    brand: "LG",
    description:
      "Energy efficient front load washing machine with steam wash and AI DD technology.",
    specifications: {
      Capacity: "7 kg",
      Type: "Front Load",
  ...
  },
  {
    ...
    brand: "Samsung",
    description:
      "High capacity top load washer with digital inverter motor and magic dispenser.",
    specifications: {
      Capacity: "8 kg",
      Type: "Top Load",
      "Energy Rating": "4 Star",
  ...
  // Sound Systems
  {
    ...
    brand: "JBL",
    description:
      "Powerful portable party speaker with LED lights and wireless microphone capability.",
    specifications: {
  ...
  },
  {
    ...
    brand: "Samsung",
    description:
      "Enhance your TV audio with this 2.1 channel soundbar featuring wireless subwoofer.",
    specifications: {
  ...
  // Cooking Appliances
  {
    ...
    brand: "LG",
    description:
      "Spacious solo microwave oven with auto cook menus and energy saving features.",
    specifications: {
      Capacity: "28 Liters",
      Type: "Solo Microwave",
      Power: "900 Watts",
  ...
  },
  {
    ...
    brand: "Generic",
    description:
      "Efficient double burner gas cooker with spacious oven for all your cooking needs.",
    specifications: {
  ...
  // Irons
  {
    ...
    brand: "Philips",
    description:
      "Powerful steam iron with ceramic soleplate for smooth gliding and wrinkle removal.",
    specifications: {
      Power: "2400 Watts",
      Soleplate: "Ceramic",
  ...
  // Other Electronics
  {
    ...
    brand: "Generic",
    description:
      "Energy efficient ceiling fan with remote control and LED lighting.",
    specifications: {
      Size: "56 inches",
