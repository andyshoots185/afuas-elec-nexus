-- Fix the conversation view since products table doesn't have image column
...
-- Create conversation view helper (fixed version)
...
SELECT DISTINCT
    ...
    -- Get first product image from product_images table
...
GROUP BY other_user_id, m.product_id, p.name, p.price_ugx
